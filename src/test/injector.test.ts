...
describe('Injector', () => {
  ...
  test('should resolve a simple class instance', async () => {
    ...
    const instance = await injector.loadInstance(wrapper, { id: 1 });
  ...
  test('should resolve class with dependencies', async () => {
    ...
    const instanceB = await injector.loadInstance(wrapperB, { id: 1 });
  ...
  test('should resolve useFactory provider', async () => {
    ...
    const instance = await injector.loadInstance(wrapperFactory, { id: 1 });
  ...
  test('should handle singleton scope (DEFAULT)', async () => {
    ...
    const instance1 = await injector.loadInstance(wrapper, { id: 1 });
    const instance2 = await injector.loadInstance(wrapper, { id: 2 });
